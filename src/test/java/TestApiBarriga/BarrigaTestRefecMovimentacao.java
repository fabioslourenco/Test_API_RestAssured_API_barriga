...
public class BarrigaTestRefecMovimentacao extends BaseTest {
    ...
    public Integer getIdMovPeloNome(String desc){
    ...
    Integer MOV_ID = getIdMovPeloNome("Movimentacao para exclusao");
        given()
                .pathParam("id", MOV_ID)
                .when()
                .delete("/transacoes/{id}")
                .then()
                // quando houver mov. criada status deve ser 204, se for repetir sem mov. para excluir deve ser 404.
                .statusCode(204)
        ;
    }
